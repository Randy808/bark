...
pub struct FreshRoundsRequest {
    #[prost(string, optional, tag = "1")]
    pub last_round_txid: ::core::option::Option<::prost::alloc::string::String>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub mod ark_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn last_round_event(
            &mut self,
            request: impl tonic::IntoRequest<super::Empty>,
        ) -> std::result::Result<tonic::Response<super::RoundEvent>, tonic::Status> {
            self.inner
                .ready()
                .await
                .map_err(|e| {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/bark_server.ArkService/LastRoundEvent",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("bark_server.ArkService", "LastRoundEvent"));
            self.inner.unary(req, path, codec).await
        }
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/bark_server.ArkService/LastRoundEvent" => {
                    #[allow(non_camel_case_types)]
                    struct LastRoundEventSvc<T: ArkService>(pub Arc<T>);
                    impl<T: ArkService> tonic::server::UnaryService<super::Empty>
                    for LastRoundEventSvc<T> {
                        type Response = super::RoundEvent;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ArkService>::last_round_event(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = LastRoundEventSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
